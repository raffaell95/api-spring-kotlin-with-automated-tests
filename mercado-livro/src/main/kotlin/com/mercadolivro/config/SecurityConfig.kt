...
class SecurityConfig(
    ...
    private val customEntryPoint: CustomAuthenticationEntryPoint): WebSecurityConfigurerAdapter() {
    ...
    override fun configure(web: WebSecurity) {
        web.ignoring().antMatchers("/v2/api-docs", "/configurarion/ui", "/swagger-resources/**",
            "/configurarion/**", "/swagger-ui/**", "/webjars/**")
    }
